...
function ValueCards({ template }) {
  return (
    <div>
      <Card sx={{ height: "10rem", border: 1, borderColor: "#007AD4" }}>
        <Typography
          variant="h5"
          sx={{
            fontSize: "1rem",
          ...
          <Grid container gap={2}>
            ...
            <Grid item>
              ...
              <Paper sx={{ height: "100%", width: "15.5rem", position: "relative" , display: "flex", justifyContent: "center", alignItems: "center"}}>
                ...
                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", padding: "1em", paddingTop: "1.5rem" }} style={{ position: "absolute", top: "0", left: "0" }}>
